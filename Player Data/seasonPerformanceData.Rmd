...
# directory (containing "Season Data/" and "Finance Data/" subfolders), or
...
csv_files <- list.files(path = file.path(dataDir, "Season Data"), pattern = "\\.csv$", full.names = TRUE)
...
```{r}
financialData <- read.csv(file.path(dataDir, "Finance Data", "financialSeasonStatsData.csv"))
