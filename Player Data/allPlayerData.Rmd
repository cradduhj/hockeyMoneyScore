...
```{r config}
# Set the HOCKEY_MONEYSCORE_DATA_DIR environment variable to your local data
# directory (containing "API Data/" and "Finance Data/" subfolders), or edit
# the default path below.
dataDir <- Sys.getenv("HOCKEY_MONEYSCORE_DATA_DIR", unset = "path/to/your/data")
```

```{r}
# read in files
playerPerformanceStats <- read.csv(file.path(dataDir, "API Data", "wrangledPlayerStatsFromAPI.csv"))
playerFinancialStats <- read.csv(file.path(dataDir, "Finance Data", "financialSeasonStatsData.csv"))
